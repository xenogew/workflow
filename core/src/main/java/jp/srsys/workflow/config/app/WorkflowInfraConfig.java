...
import jp.srsys.workflow.config.app.mybatis.MybatisConfig;

/**
 * Bean definitions for infrastructure layer.
 */
@Configuration
@MapperScan("jp.srsys.workflow.domain.repository")
@Import({WorkflowEnvConfig.class})
public class WorkflowInfraConfig {

    /**
     * Configure {@link SqlSessionFactoryBean} bean.
     * @param dataSource DataSource
     * @see jp.srsys.workflow.config.app.WorkflowEnvConfig#dataSource()
