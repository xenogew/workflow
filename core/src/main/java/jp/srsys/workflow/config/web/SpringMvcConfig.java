package jp.srsys.workflow.config.web;
 ...
 * Configure SpringMVC.
 */
@ComponentScan(basePackages = {"jp.srsys.workflow.app"})
...
public class SpringMvcConfig implements WebMvcConfigurer {
     ...
     * @see jp.srsys.workflow.config.app.ApplicationContextConfig#exceptionCodeResolver()
