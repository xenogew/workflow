    ...
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(
        render2.call(
          ...
          proxyToUse,
          renderCache,
          !!(define_process_env_default.NODE_ENV !== "production") ? shallowReadonly(props) : props,
          setupState,
          data,
          ctx
        )
...
const Chart2 = /* @__PURE__ */ defineComponent({
  props: Props,
  setup(props, param) {
...
const weekChartElement = /* @__PURE__ */ defineCustomElement(_sfc_main);
